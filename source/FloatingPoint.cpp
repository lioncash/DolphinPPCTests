...
void PPCFloatingPointTests()
{
    ...
    OPTEST_2_COMPONENTS("FRES", std::numeric_limits<double>::max());
    OPTEST_2_COMPONENTS("FRES", std::numeric_limits<float>::max());
    ...
    OPTEST_2_COMPONENTS_WITH_ROUND("FRSP", -0.0);
    OPTEST_2_COMPONENTS_WITH_ROUND("FRSP", std::numeric_limits<double>::min());
    OPTEST_2_COMPONENTS_WITH_ROUND("FRSP", std::numeric_limits<double>::max());
    ...
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUB", std::numeric_limits<double>::max(), std::numeric_limits<double>::max());
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUB", -std::numeric_limits<double>::max(), -std::numeric_limits<double>::max());
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUB", std::numeric_limits<double>::max(), -std::numeric_limits<double>::max());
    ...
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUBS", std::numeric_limits<double>::max(), std::numeric_limits<double>::max());
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUBS", -std::numeric_limits<double>::max(), -std::numeric_limits<double>::max());
    OPTEST_3_COMPONENTS_WITH_ROUND("FSUBS", std::numeric_limits<double>::max(), -std::numeric_limits<double>::max());
